...
import heroImage from "/src/images/hero/construction-hero.jpg";
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl px-4">
        ...
        <p className="text-white text-lg sm:text-xl mb-8">
          Civieways Construction Company delivers high-quality construction services
          for residential, commercial, and industrial projects across Kenya.
        </p>
